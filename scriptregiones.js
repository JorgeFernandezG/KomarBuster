var RegionesYcomunas = {
	"regiones": [
		...
		{ "NombreRegion": "Región del Ñuble", "comunas": ["Chillán", "Bulnes", "Cobquecura", "Coelemu", "Coihueco", "Chillán Viejo", "El Carmen", "Ninhue", "Ñiquén", "Pemuco", "Pinto", "Portezuelo", "Quillón", "Quirihue", "Ránquil", "San Carlos", "San Fabián", "San Ignacio", "San Nicolás", "Treguaco", "Yungay"] },
...
jQuery(document).ready(function () {
	// Generar las opciones de regiones y comunas solo una vez
	...
	jQuery('#comunas').html('<option value="sin-comuna">Seleccione comuna</option><option value="sin-comuna">--</option>');
	...
	jQuery('#regiones').change(function () {
		...
		// Encontrar la región seleccionada y generar las opciones de comunas
		var region = RegionesYcomunas.regiones.find(r => r.NombreRegion === selectedRegion);
